...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(StartingParameters, start_offset_seconds, num_start_drones)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(DroneParameters,
                                                ...
                                                expected_lifetime,
                                                reliability_factor)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(Faction, active, name, color, startParams, droneParams)
